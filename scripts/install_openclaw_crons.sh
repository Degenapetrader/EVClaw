...
UPDATE_CHANGELOG_MD_PATH="${EVCLAW_UPDATE_CHANGELOG_MD_PATH:-$RUNTIME_DIR/repo_update_changelog.md}"
...
Repo update changelog: $UPDATE_CHANGELOG_MD_PATH
...
5) If repo_update_status=UPDATE_AVAILABLE and notify_user=yes, include changelog entries from $UPDATE_CHANGELOG_MD_PATH and ask user:
