...
REQ=(evclaw-cycle-trigger evclaw-live-agent evclaw-live-monitor evclaw-fill-reconciler evclaw-exit-decider evclaw-hip3-exit-decider evclaw-exit-outcome evclaw-decay evclaw-review)
